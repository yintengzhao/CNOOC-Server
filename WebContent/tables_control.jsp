        ...
        <ul class="altMenu">
            ...
            <li><a href="tables.html" title="" class="exp" id="current">Tables</a>
                <ul>
                    ...
                    <li><a href="tables_control.html" class="active">Tables with control</a></li>
        ...
        <div class="secWrapper">
            ...
            <div id="tab-container" class="tab-container">
                <ul class="iconsLine ic2 etabs">
                    <li><a href="#general" title=""><span class="icos-admin2"></span></a></li>
                    <li><a href="#somestuff" title=""><span class="icos-camera3"></span></a></li>
                </ul>
                ...
                <div id="general">
                    <ul class="subNav">
                        ...
                        <li><a href="tables_control.html" title="" class="this"><span class="icos-bullseye"></span>Tables with control</a></li>
...
<div id="content">
    <div class="contentTop">
        <span class="pageTitle"><span class="icon-wrench-2"></span>Tables with control</span>
        <ul class="quickStats">
            <li>
    ...
    <div class="breadLine">
        <div class="bc">
            <ul id="breadcrumbs" class="breadcrumbs">
                ...
                <li class="current"><a href="tables_control.html" title="">Tables with control</a></li>
            </ul>
        </div>
    ...
    <div class="wrapper">
        ...
        <!-- Control buttons -->
        <div class="widget">
            <div class="whead"><h6>Standard control buttons</h6><div class="clear"></div></div>
            <table cellpadding="0" cellspacing="0" width="100%" class="tDefault">
                <thead>
                    <tr>
                        <td>Very simple dropdown</td>
                        <td>With simple toolbar</td>
                        <td>With dropdown</td>
                ...
                <tbody>
                    <tr>
                        ...
                        <td align="center" class="tableToolbar">
                            <ul class="btn-group toolbar">
                                <li><a href="#" class="tablectrl_small bDefault"><span class="iconb" data-icon="&#xe1db;"></span></a></li>
                                <li><a href="#" class="tablectrl_small bDefault"><span class="iconb" data-icon="&#xe136;"></span></a></li>
                        ...
                        <td class="tableActs" align="center">
                            <div class="btn-group">
                              <a href="#" class="tablectrl_small bDefault" data-toggle="dropdown"><span class="iconb" data-icon="&#xe1db;"></span></a>
                              <ul class="dropdown-menu pull-right">
                                    <li><a href="#"><span class="icos-add"></span>Add</a></li>
                                    <li><a href="#"><span class="icos-trash"></span>Remove</a></li>
                                    <li><a href="#" class=""><span class="icos-pencil"></span>Edit</a></li>
                        ...
                        <td class="tableActs" align="center">
                            ...
                            <a href="#" class="tablectrl_small bBlue tipS" title="Options"><span class="iconb" data-icon="&#xe1f7;"></span></a>
                        </td>
                        <td class="tableActs" align="center">
                    ...
                    <tr>
                        ...
                        <td class="tableActs" align="center">
                            <a href="#" class="tablectrl_small bLightBlue tipS" title="Edit"><span class="iconb" data-icon="&#xe1db;"></span></a>
                            <a href="#" class="tablectrl_small bBrown tipS" title="Remove"><span class="iconb" data-icon="&#xe136;"></span></a>
                            <a href="#" class="tablectrl_small bGold tipS" title="Options"><span class="iconb" data-icon="&#xe1f7;"></span></a>
                        </td>
                        <td class="tableActs" align="center">
                            <a href="#" class="tablectrl_small bDefault tipS" title="Edit"><span class="iconb" data-icon="&#xe1db;"></span></a>
                            <a href="#" class="tablectrl_small bDefault tipS" title="Remove"><span class="iconb" data-icon="&#xe136;"></span></a>
                    ...
                    <tr>
                        ...
                        <td class="tableActs" align="center">
                            <a href="#" class="tablectrl_small bGreyish tipS" title="Edit"><span class="iconb" data-icon="&#xe1db;"></span></a>
                            <a href="#" class="tablectrl_small bGreen tipS" title="Remove"><span class="iconb" data-icon="&#xe136;"></span></a>
                            <a href="#" class="tablectrl_small bSea tipS" title="Options"><span class="iconb" data-icon="&#xe1f7;"></span></a>
                        </td>
                        <td class="tableActs" align="center">
                            <a href="#" class="tablectrl_small bDefault tipS" title="Edit"><span class="iconb" data-icon="&#xe1db;"></span></a>
                            <a href="#" class="tablectrl_small bDefault tipS" title="Remove"><span class="iconb" data-icon="&#xe136;"></span></a>
        ...
        <div class="widget check">
            <div class="whead"><span class="titleIcon"><input type="checkbox" id="titleCheck" name="titleCheck" /></span><h6>Media table</h6><div class="clear"></div></div>
            <table cellpadding="0" cellspacing="0" width="100%" class="tDefault checkAll tMedia" id="checkAll">
                ...
                <script type="text/javascript">
                 $.ajax(
                		url:"http://10.134.78.134:8888/ssh/material/list",
                		async:true,
        ...
        <div class="widget">
            ...
            <ul class="tToolbar">
                <li><a href="#" title=""><span class="icos-inbox"></span>Import table content</a></li>
